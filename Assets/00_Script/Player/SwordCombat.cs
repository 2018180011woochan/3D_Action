...
public class SwordCombat : MonoBehaviour
{
    ...
    public TimelineAsset battoSkillTimeline;
    ...
    void Update()
    {
        if (playerCombat.IsPlayingCutscene)
            return;
...
/*        if (InventoryManager.instance.IsInventoryOpen())
    ...
    {
        if (playerCombat.playerCamera != null && battojutsuCamera != null)
        {
    ...
    public void Attack1Effect()
    {
        ...
        Instantiate(slashEffectPrefab, swordTransform.position, rot);
    }
    ...
    public void Attack2Effect()
    {
        ...
        for (int i = 0; i < 4; i++)
        {
            ...
            Instantiate(slashEffectPrefab, spawnPos, dirRot);
        }
    }
    ...
    public void Attack3Effect()
    {
        ...
        Instantiate(FinalAttackEffectPrefab, swordTransform.position, rot);
    }
